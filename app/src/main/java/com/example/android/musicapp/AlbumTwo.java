...
public class AlbumTwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        albumSongs.add(new Song("Song Name One","Artist Name Two"));
        albumSongs.add(new Song("Song Name Two","Artist Name Two"));
        albumSongs.add(new Song("Song Name Three","Artist Name Two"));
