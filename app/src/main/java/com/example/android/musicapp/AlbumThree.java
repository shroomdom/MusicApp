...
public class AlbumThree extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        albumSongs.add(new Song("Song Name One","Artist Name Three"));
        albumSongs.add(new Song("Song Name Two","Artist Name Three"));
        albumSongs.add(new Song("Song Name Three","Artist Name Three"));
